...
def get_access_token():
    ...
    data = "grant_type=urn:ibm:params:oauth:grant-type:apikey&apikey=_y1bePwozFIQ1J1DUMuHTYmm8V_8rWcGUekLt-Jiq6x7"
...
def get_prediction(access_token, *input_values):
    url = "https://us-south.ml.cloud.ibm.com/ml/v4/deployments/49a758e4-dca1-481e-a31d-b04bb43faff7/predictions?version=2021-05-01"
    headers = CaseInsensitiveDict()
